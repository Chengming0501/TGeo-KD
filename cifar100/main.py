...
def parse_args():
    ...
    parser.add_argument('--adapt', type=int, default=0, choices=[0, 1, 2, 3 ], help='0 for original KD, 1 for ours')
    parser.add_argument('--seed', type=int, default=0)
    parser.add_argument('--model_arch', type=str, required=True,) #choices=['resnet34', 'resnet50', 'resnet18',
                                                                          # 'resnet101', 'inceptionv4', ])
    ...
    parser.add_argument('--gamma', type=float, default=0.2, help='Learning rate decay multiplier')
